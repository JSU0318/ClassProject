...
void loop() {
  ...
  e3_1 = analogRead(A8);
  e3_2 = analogRead(A9);
  //Serial.print("Angle GX:");
  Serial.print(angleGyX);Serial.print(",");
  //Serial.print("\t Angle Gy:");
  Serial.print(angleGyY);  Serial.print(",");
  //Serial.print("\t Angle GZ:");
  Serial.print(angleGyZ);  Serial.print(",");
  //Serial.print("\t e1_1: ");
  Serial.print(e1_1);  Serial.print(",");
  //Serial.print("\t e1_2: ");
  Serial.print(e1_2);  Serial.print(",");
  //Serial.print("\t e2_1: ");
  Serial.print(e2_1);  Serial.print(",");
  //Serial.print("\t e2_2: ");
  Serial.print(e2_2); Serial.print(",");
  //Serial.print("\t e3_1: ");
  Serial.print(e3_1);  Serial.print(",");
  //Serial.print("\t e3_2: ");
  Serial.println(e3_2);
  delay(100);
  count_value++;
...
void getData() {
  ...
  Wire.write(0x3B);   // AcX 레지스터 위치(주소)를 지칭
